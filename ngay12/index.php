...
<div class="container">
    ...
    <div class="row">
        <p id="net" style="color: #f7941d; margin: 30px; font-size: 24px">Lương net : </p>
        <?php
        ...
        if($tnct<=5000000)
            ...
            $ttncn=$tnct*20/100;
        else if ($tnct>3200000&&$tnct<=52000000)
            $ttncn=$tnct*25/100;
        else if ($tnct>5200000&&$tnct<=80000000)
            $ttncn=$tnct*30/100;
        else
            $ttncn=$tnct*35/100;
        print_r($_POST['gross']-$bh-$ttncn);?>
